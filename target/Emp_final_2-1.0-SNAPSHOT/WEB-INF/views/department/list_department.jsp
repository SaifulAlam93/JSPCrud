                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-status-wrap drp-lst">
                                ...
                                <div class="add-product">
                                    <a href="add_department_form">Add Department</a>
                                </div>
                                    ...
                                    <table>
                                        ...
                                        <c:forEach var="emp" items="${list}">  
                                            ...
                                            <tr> 
                                                ...
                                                <td>
                                                    <a href="delete_department?id=${emp.id}" data-toggle="tooltip" title="Trash" class="pd-setting-ed"  onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>
                                ...
                                <div class="custom-pagination">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item"><a class="page-link" href="list_department?pageID=0">1</a></li>
                                            <li class="page-item"><a class="page-link" href="list_department?pageID=10">2</a></li>
                                            <li class="page-item"><a class="page-link" href="list_department?pageID=20">3</a></li>
