                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <form:form  method="post" action="add_employee" class="add-department">
                                                        
                                             
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <form:input path="employeeId" type="number" class="form-control" placeholder="Employee Id"/>
                                                                </div>
                                                                <div class="form-group">
                                                                    <form:input path="employeeName" type="text" class="form-control" placeholder="Name"/>
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                  ...
                                                                  <div class="form-group">
                                                                    <form:input path="department.id" type="number" class="form-control" placeholder="department Id (numaric)"/>
                                                                </div>
