                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="breadcome-list single-page-breadcome" >
                                    <div class="row" >
                                        <div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="text-center" class="breadcome-heading" >
                                                <span class="text-center" ><img style="max-height: 500px;max-width: 800px" class="main-logo" src="img/welcome2.jpg" alt="" /></span>
