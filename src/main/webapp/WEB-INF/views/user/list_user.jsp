                                    ...
                                    <table>
                                        ...
                                        <c:forEach var="emp" items="${list}">  
                                            ...
                                            <tr> 
                                                ...
                                                <td>
                                                    <a href="edit_user_form?id=${emp.id}" data-toggle="tooltip" title="Edit" class="pd-setting-ed"    ><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></a> &nbsp;
                                                    <a href="delete_user?id=${emp.id}" data-toggle="tooltip" title="Trash" class="pd-setting-ed"  onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>
                                ...
                                <div class="custom-pagination">
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item"><a class="page-link" href="list_user?pageID=0">1</a></li>
                                            <li class="page-item"><a class="page-link" href="list_user?pageID=10">2</a></li>
                                            <li class="page-item"><a class="page-link" href="list_user?pageID=20">3</a></li>
