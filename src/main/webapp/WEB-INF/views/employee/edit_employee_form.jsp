                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <form:form method="post" action="edit_employee" class="add-department">
                                                        <form:hidden path="id"/>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <form:input path="employeeId" type="number" class="form-control" placeholder="Employee Id" readonly="true"/>
                                                                </div>
                                                                <div class="form-group">
